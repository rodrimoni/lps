...
# counts
ggp2 + geom_bar(fill="darkred", stat = "identity") + xlab("Time of the Day") + ylab("Number of accidents") + geom_text(aes(label=N), vjust=1.6, color="white", size=5.5) + theme_bw(base_size = 22) + scale_y_continuous(breaks=c(seq(0,1400, 250))) +  
  theme (
